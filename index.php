    ...
    <body>
        <nav>
            ...
            <ul id="menu">
                ...
                <li><a href="https://www.google.co.id/">SEARCH</a></li>
                <li><a href="https://www.bbc.com/news/world">NEWS</a></li>
                <li><a href="music/Life is Strange">MY MUSIC</a></li>   
            </ul>
        </nav>

        <section id="box-profile">
            <div class="img-profile">
                <div class="photo" style="background-image: url(assets/img/sick.jpg)"></div>
            </div>
            ...
            <div class="information"> 
                ...
                <div class="data">
                        <p class="field">School Experience</p>
